    ...
    <nav className="nav-bar">
      <div className="container">
        <div className="nav-bar-inner">
          ...
          <ul className={`nav-links ${mobileOpen ? 'show' : ''}`} id="navLinksMenu">
            ...
            <li className="nav-item">
              ...
              <ul className="cat-dropdown">
                ...
                <li className="dropdown-submenu">
                  <Link to="/about-lapp" title="View LAPP India Make Sheet" onClick={() => setMobileOpen(false)}>
                    <span>Lapp Products</span>
                    <span>&rarr;</span>
                  </Link>
                  <ul className="submenu-list submenu-lapp">
                    <li>
                      <Link to="/olflex-cables" onClick={() => setMobileOpen(false)}>
                        Power &amp; Control Cables (ÖLFLEX®)
                      </Link>
                    </li>
                    <li>
                      <Link to="/about-lapp" onClick={() => setMobileOpen(false)}>
                ...
                {/* Eaton Submenu */}
                <li className="dropdown-submenu">
                  <Link to="/about-eaton" title="View EATON Moeller Make Sheet" onClick={() => setMobileOpen(false)}>
                    <span>Eaton Products</span>
                    <span>&rarr;</span>
                  </Link>
                  <ul className="submenu-list submenu-eaton">
                    <li>
                      <Link to="/about-eaton" onClick={() => setMobileOpen(false)}>
                ...
                {/* Partex Submenu */}
                <li className="dropdown-submenu">
                  <Link to="/about-partex" title="View PARTEX Sweden Make Sheet" onClick={() => setMobileOpen(false)}>
                    <span>Partex Products</span>
                    <span>&rarr;</span>
                  </Link>
                  <ul className="submenu-list submenu-partex">
                    <li>
                      <Link to="/about-partex" onClick={() => setMobileOpen(false)}>
                ...
                {/* Mennekes Submenu */}
                <li className="dropdown-submenu">
                  <Link to="/about-mennekes" title="View MENNEKES Germany Make Sheet" onClick={() => setMobileOpen(false)}>
                    <span>Mennekes Products</span>
                    <span>&rarr;</span>
                  </Link>
                  <ul className="submenu-list submenu-mennekes">
                    <li>
                      <Link to="/about-mennekes" onClick={() => setMobileOpen(false)}>
            ...
            <li className="nav-item">
              <Link to="/olflex-cables" className="nav-link" onClick={() => setMobileOpen(false)}>
                ÖLFLEX® Cables Catalog
              </Link>
            </li>
