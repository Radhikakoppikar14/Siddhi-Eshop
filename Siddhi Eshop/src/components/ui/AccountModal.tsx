...
export const AccountModal: React.FC = () => {
  const { currentUser, accountModalOpen, closeAccountModal, logout, userOffers } = useAuth();
  ...
  return (
    <div className="modal-overlay open" id="customerAccountModal" onClick={closeAccountModal}>
      <div className="modal-card account-modal-card" onClick={e => e.stopPropagation()}>
        <button className="modal-close" onClick={closeAccountModal} aria-label="Close">
          <X size={18} />
        </button>
        ...
        <div className="account-modal-header">
          ...
          <div className="account-header-info">
            <h3 id="accountModalCompanyName" style={{ margin: '0 0 4px', fontSize: '18px', color: '#1e293b' }}>
              {currentUser.companyName}
            </h3>
            <p style={{ margin: 0, fontSize: '13px', color: '#64748b' }}>
              <span id="accountModalContact">{currentUser.contactPerson}</span> • GSTIN:{' '}
        ...
        <div className="account-modal-body">
          ...
          <div className="account-offers-section">
            <h4 style={{ fontSize: '15px', marginBottom: '12px', color: 'var(--gray-900)' }}>
              ...
              {userOffers.length === 0 ? (
                ...
                userOffers.map(o => (
                  <div className="offer-item-card" key={o.refNo}>
                    ...
                    {o.notes && (
                      <div style={{ color: '#475569', marginTop: '3px', fontSize: '12.5px' }}>
                        "{o.notes.slice(0, 85)}..."
                      </div>
                    )}
                    {o.filesCount > 0 && (
