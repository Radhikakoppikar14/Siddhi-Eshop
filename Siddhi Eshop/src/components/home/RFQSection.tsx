...
export const RFQSection: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    addOffer({
      ...
      company: company || currentUser.companyName,
      name: name || currentUser.contactPerson,
      ...
      <div className="container">
            ...
            <div className="rfq-auth-notice authenticated">
              <div className="auth-notice-body">
                ...
                <div className="auth-notice-text">
                  <strong>Verified Customer: {currentUser.companyName} ({currentUser.contactPerson})</strong>
                  <span>GSTIN: {currentUser.gstNo} • Ready to dispatch formal quotation request</span>
                </div>
              </div>
              <button
                type="button"
            ...
            <div className="rfq-auth-notice unauthenticated">
              <div className="auth-notice-body">
                ...
                <div className="auth-notice-text">
                  ...
                  <span>Please create an account or sign in to dispatch your official commercial offer &amp; BOM.</span>
                </div>
              </div>
              <button
                type="button"
        ...
        <div className="rfq-wrapper">
          ...
          <div className="rfq-info-col">
            <div>
              <span style={{ fontSize: '12px', fontWeight: 800, color: '#ff8589', textTransform: 'uppercase', letterSpacing: '1px' }}>
                Direct Procurement Portal
              </span>
              <h3>Request a Bulk Quotation (RFQ)</h3>
              <p>
                Send us your Bill of Materials (BOM), cable schedule, or switchgear project specifications. Our industrial sales engineers provide guaranteed pricing and delivery schedules within 2 to 4 business hours.
              </p>

              <div className="rfq-highlights">
                <div className="rfq-hl-item">
                  <Check size={16} strokeWidth={2.5} style={{ flexShrink: 0, marginTop: '2px' }} />
                  <span>Direct OEM / Panel Builder Volume Tiered Discounts</span>
                </div>
                <div className="rfq-hl-item">
                  <Check size={16} strokeWidth={2.5} style={{ flexShrink: 0, marginTop: '2px' }} />
                  <span>Manufacturer Test Certificates &amp; Mill Compliance Reports</span>
                </div>
                <div className="rfq-hl-item">
                  <Check size={16} strokeWidth={2.5} style={{ flexShrink: 0, marginTop: '2px' }} />
                  <span>Dedicated Bangalore Central Warehouse &amp; Logistics</span>
                </div>
              </div>
            </div>
            ...
            <div className="rfq-direct-help">
              ...
              <strong style={{ display: 'block', marginTop: '4px' }}>sales@siddhikabel.com</strong>
              <strong>Enquiry@siddhikabel.com</strong>
              <span style={{ marginTop: '8px' }}>Phone: 096200 00947 / 098860 58511</span>
            </div>
          </div>
